document.addEventListener('DOMContentLoaded', () => {
    ...
    svg.append('circle')
        ...
        */
        ...
        // Assign the sun image to a variable
const sun = svg.append('image')
.attr('xlink:href', 'img/sun4.png') // replace with your image path
.attr('width', 150) // adjust as needed
.attr('height', 150) // adjust as needed
.attr('x', width / 2 - 75) // adjust as needed
.attr('y', height / 2 - 75); // adjust as needed

// Function to make the sun shake
const shakeSun = () => {
    sun.transition()
        .duration(2000) // further increased duration
        .ease(d3.easeSin)
...
// Make the sun shake continuously
setInterval(shakeSun, 6000); // further increased interval
